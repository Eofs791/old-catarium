...
![](https://cdn.jsdelivr.net/gh/Eofs791/catpic@main/posts/20251031/0BF1E6573B06C183E491CD689DAAB0C2.png)
<!-- more -->
...
确保你有root权限，如果系统提示你不是root，安装了``pip``但无法使用，可以尝试创建虚拟环境再部署。
```shell
# 检查Python
python -V
python --version
...
nc默认的webui地址为``0.0.0.0``（或者主机IP），接口为``6099``。Token请查看启动日志。   
